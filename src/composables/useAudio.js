...
/**
 * Captures teacher microphone audio purely to drive the audio-level meter
 * (mic permission + visual feedback). Actual speech recognition is handled
 * separately by useBrowserStt.js (free/test path) or, once wired, a raw
 * audio WebSocket to a real backend STT provider.
 */
