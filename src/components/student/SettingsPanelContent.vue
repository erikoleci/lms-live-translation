<template>
  <div class="pa-4 d-flex flex-column gap-4">
    ...
    <v-card rounded="xl" elevation="0" border>
      ...
      <v-card-text class="px-4 pb-4">
        ...
        <v-switch
          ...
          color="primary" density="compact" hide-details class="mt-3"
    ...
    <v-card rounded="xl" elevation="0" border>
      <v-card-title class="text-body-2 font-weight-bold pt-3 px-4">
        <v-icon start size="16" color="primary">mdi-volume-high</v-icon>
        Audio
      </v-card-title>
      <v-card-text class="px-4 pb-4">
        <v-switch
        ...
        <v-sheet
          ...
          rounded="lg"
          class="d-flex align-center gap-2 pa-2 mb-4"
        >
    ...
    <v-card rounded="xl" elevation="0" border>
      ...
      <v-card-text class="px-4 pb-4">
        <div v-if="participants.length" class="d-flex flex-column gap-2">
          <div v-for="p in participants" :key="p.id" class="d-flex align-center gap-2">
